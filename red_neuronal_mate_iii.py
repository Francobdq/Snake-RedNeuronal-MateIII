# -*- coding: utf-8 -*-
"""Red Neuronal Mate III.ipynb

Automatically generated by Colaboratory.

Original file is located at
NOTA: La versión que esta en google colab es una versión previa a esta (sin interfaz gráfica y con algunos ligeros cambios pero funciona igualmente para las estadisticas).
    https://colab.research.google.com/drive/1-EcuN2QIwSnDhv8UNZynogp60pdqPB4Z
"""
...
class SeleccionNatural():
  ...
  def __Mejora(self, funcionDeCoste, probabilidadDeMutar, generacionNum = 0, versus = False):
    ...
    if(self.mejorGlobal == None or maximo > self.mejorPuntuacionGlobal): # Si no existe el mejor aún o bien el maximo actual supera al maximo global
...
cantGeneraciones = 10 # Cambiar este valor para alternar la cantidad de generaciónes maximas
